...
export default class EndGameScore {    
    ...
    drawRank(){
        ...
        if(topScores != null){
            ...
            this.ctx.fillStyle = '#fff';
            this.ctx.font = "14px";
            this.ctx.fillText("= 全国TOP 10 =", window.innerWidth / 2 - (("= 全国TOP 10 =".length) * 7), window.innerHeight / 6 + 18);
            ...
            for(var i=0; i<topScores.length; i++){
                ...
                this.ctx.fillStyle = '#fff';
                this.ctx.fillText(topScores[i].name, window.innerWidth / 10 + 20, window.innerHeight / 6 + 48 + i*30+5);
